...
( function ( $ ) {
	function initialize_field( $field ) {
		...
		$field.find( '.link-type-select' ).on( 'change', function () {
			...
			var linkContentField = $field.find(
				'.acf-info-button-link-content'
			);

			linkContentField
				.find( '.acf-info-button-internal-link' )
				.toggle( linkType === 'internal' );
			linkContentField
				.find( '.acf-info-button-external-link' )
				.toggle( linkType === 'external' );
		} );
